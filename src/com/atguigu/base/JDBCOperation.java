...
public class JDBCOperation {
    ...
    public void testQuerySingleRow() throws SQLException {
        ...
        //4.为占位符赋值，然后执行，并接受结果
        // 这行代码将整数 5 设置为 SQL 查询中的第一个占位符 ? 的值。1 表示第一个占位符（索引从 1 开始），5 是实际要插入的参数值。
    ...
    public void testDelete() throws SQLException {
        ...
        //2.获取连接
        Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/atguigu", "root", "abc123");
